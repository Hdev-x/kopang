...
import { getOrderDetails, cancelOrder, formatOrderStatus } from "../../api/order";
...
export function OrderDetailPage() {
  ...
  const dummyTracking = [
    { step: "결제완료", done: order.paymentStatus === "PAID" },
    { step: "상품준비중", done: false },
    { step: "배송중", done: false },
    { step: "배송완료", done: false },
  ];
    ...
    <Layout>
      ...
      <Card>
        ...
        {order.paymentStatus === "PAID" && (
          <div className={s.row} style={{ marginTop: "12px", justifyContent: "flex-end" }}>
            <Button variant="ghost" size="sm" onClick={handleCancel} style={{ color: "var(--red-600)", borderColor: "var(--red-200)" }}>
              주문 취소
            </Button>
          </div>
